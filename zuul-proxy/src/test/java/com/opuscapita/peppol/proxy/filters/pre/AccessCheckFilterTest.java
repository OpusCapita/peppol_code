...
public class AccessCheckFilterTest {
    ...
    public void isNotAllowed() throws Exception {
        ...
        testSubject = new AccessCheckFilter(specificIpRangePerFilterWithProhibitedMask, zuulServletPath);
        ...
        testSubject = new AccessCheckFilter(specificIpRangePerFilterWithProhibitedMaskAndNetworkOverrides, zuulServletPath);
        assertFalse(testSubject.isNotAllowed(inboundRequestMock));
