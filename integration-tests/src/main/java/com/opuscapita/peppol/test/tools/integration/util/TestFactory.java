...
public class TestFactory {
    private final static Logger logger = LogManager.getLogger(TestFactory.class);

    public static Test createTest(String moduleName, Map<String, ?> moduleSettings) {
        ...
        return new Test(moduleName, producers, subscribers, consumers);
    }
}
