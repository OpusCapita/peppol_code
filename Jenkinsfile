    ...
    node {
        stage('Checkout') {
            ...
            checkout([
                ...
                userRemoteConfigs: [[
                   url: 'git@github.com:OpusCapita/peppol_code.git',
            ...
            checkout([
                ...
                userRemoteConfigs: [[
                   url: 'git@github.com:OpusCapita/peppol_infrastructure.git',
                   credentialsId: '04b0363e-4e04-4882-8b51-511cd3f3ac21'
                ]],
...
def release(release_version, next_version, code_version, code_hash, infra_version, infra_hash) {
    ...
    sshagent (credentials: ['04b0363e-4e04-4882-8b51-511cd3f3ac21']) {
