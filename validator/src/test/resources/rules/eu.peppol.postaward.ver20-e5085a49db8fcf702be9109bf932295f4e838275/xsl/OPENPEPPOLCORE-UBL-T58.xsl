<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
   ...
   <xsl:template match="/">
      <svrl:schematron-output xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                              title="OPENPEPPOL CORE T58 bound to UBL"
                              schemaVersion="iso">
         <xsl:comment>
   ...
   <!--SCHEMATRON PATTERNS-->
   <svrl:text xmlns:svrl="http://purl.oclc.org/dsdl/svrl">OPENPEPPOL CORE T58 bound to UBL</svrl:text>
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="false()">
               ...
               <svrl:text>
	Element 'cac:LineResponse' is marked as not used in the given context.</svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
   ...
   <!--PATTERN -->
	  ...
	  <!--RULE -->
   <xsl:template match="/p1:ApplicationResponse/cac:DocumentResponse/cac:Response/cbc:Description"
                 priority="1000"
                 mode="M41">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                       context="/p1:ApplicationResponse/cac:DocumentResponse/cac:Response/cbc:Description"/>
