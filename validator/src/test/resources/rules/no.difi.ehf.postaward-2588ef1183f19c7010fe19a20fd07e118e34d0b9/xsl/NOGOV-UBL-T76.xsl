<xsl:stylesheet
   ...
   <xsl:template match="/">
      <svrl:schematron-output xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                              title="Norwegian rules for EHF Order Response"
                              schemaVersion="iso">
         <xsl:comment>
   ...
   <!--PATTERN -->
	  ...
	  <!--RULE -->
   <xsl:template match="cac:BuyerCustomerParty" priority="1005" mode="M4">
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="cac:Party/cbc:EndpointID">
	  ...
	  <!--RULE -->
   <xsl:template match="cac:SellerSupplierParty" priority="1004" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
	  ...
	  <!--RULE -->
   <xsl:template match="cac:TaxScheme" priority="1003" mode="M4">
	  ...
	  <!--RULE -->
   <xsl:template match="cac:Delivery" priority="1002" mode="M4">
