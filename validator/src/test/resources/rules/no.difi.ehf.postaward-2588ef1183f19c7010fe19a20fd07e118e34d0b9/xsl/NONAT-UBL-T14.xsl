<xsl:stylesheet xmlns:xs="http://www.w3.org/2001/XMLSchema"
   ...
   <xsl:variable name="taxCategories"
	  ...
	  <!--RULE -->
   <xsl:template match="ubl:CreditNote" priority="1012" mode="M8">
	  ...
	  <!--RULE -->
   <xsl:template match="cbc:UBLVersionID" priority="1011" mode="M8">
   ...
   <xsl:template match="cac:AccountingCustomerParty/cac:Party"
	  ...
	  <!--RULE -->
   <xsl:template match="cac:PartyLegalEntity" priority="1008" mode="M8">
   ...
   <xsl:template match="cac:PayeeFinancialAccount/cbc:ID[@schemeID]"
	  ...
	  <!--RULE -->
   <xsl:template match="cac:LegalMonetaryTotal" priority="1005" mode="M8">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
	  ...
	  <!--RULE -->
   <xsl:template match="cac:AllowanceCharge" priority="1004" mode="M8">
