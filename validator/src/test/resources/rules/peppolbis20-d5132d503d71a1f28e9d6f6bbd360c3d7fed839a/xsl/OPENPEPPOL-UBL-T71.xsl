...
<xsl:stylesheet
   ...
   <xsl:template match="//cac:DocumentReference/cbc:DocumentTypeCode"
	  ...
	  <!--RULE -->
   <xsl:template match="//cac:Response/cbc:ResponseCode" priority="1004" mode="M6">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
	  ...
	  <!--RULE -->
   <xsl:template match="//cac:Status/cbc:StatusReasonCode" priority="1003" mode="M6">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
   ...
   <xsl:template match="cac:PartyIdentification/cbc:ID//@schemeID"
	  ...
	  <!--RULE -->
   <xsl:template match="cac:Status//cbc:StatusReasonCode" priority="1000" mode="M7">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                       context="cac:Status//cbc:StatusReasonCode"/>
