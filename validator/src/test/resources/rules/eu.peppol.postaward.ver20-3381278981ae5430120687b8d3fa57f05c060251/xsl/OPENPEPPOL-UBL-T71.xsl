...
<xsl:stylesheet
   ...
   <xsl:template match="/">
      <svrl:schematron-output xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                              title="OPENPEPPOL  T71 bound to UBL"
                              schemaVersion="">
         <xsl:comment>
         ...
         <svrl:active-pattern>
            ...
            <xsl:attribute name="id">CodesT71</xsl:attribute>
            <xsl:attribute name="name">CodesT71</xsl:attribute>
            <xsl:apply-templates/>
         </svrl:active-pattern>
   ...
   <!--SCHEMATRON PATTERNS-->
   <svrl:text xmlns:svrl="http://purl.oclc.org/dsdl/svrl">OPENPEPPOL  T71 bound to UBL</svrl:text>
   ...
   <xsl:template match="//cac:DocumentReference/cbc:DocumentTypeCode"
      ...
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                       context="//cac:DocumentReference/cbc:DocumentTypeCode"/>
	  ...
	  <!--RULE -->
   <xsl:template match="//cac:Response/cbc:ResponseCode" priority="1004" mode="M7">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                       context="//cac:Response/cbc:ResponseCode"/>
	  ...
	  <!--RULE -->
   <xsl:template match="//cac:Status/cbc:StatusReasonCode" priority="1003" mode="M7">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                       context="//cac:Status/cbc:StatusReasonCode"/>

		    <!--ASSERT -->
      <xsl:choose>
         <xsl:when test="@listID = 'PEPPOLSTATUS'"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="@listID = 'PEPPOLSTATUS'">
	  ...
	  <!--RULE -->
   <xsl:template match="//cbc:EndpointID" priority="1002" mode="M7">
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
               ...
               <xsl:attribute name="id">EUGEN-T71-R006</xsl:attribute>
               <xsl:attribute name="flag">warning</xsl:attribute>
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
               </xsl:attribute>
               <svrl:text>[EUGEN-T71-R006]- A message level response should not contain empty elements</svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
      <xsl:apply-templates select="@*|*|comment()|processing-instruction()" mode="M7"/>
   ...
   <!--PATTERN CodesT71-->
	  ...
	  <!--RULE -->
   <xsl:template match="cbc:EndpointID//@schemeID" priority="1002" mode="M8">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
   ...
   <xsl:template match="cac:PartyIdentification/cbc:ID//@schemeID"
	  ...
	  <!--RULE -->
   <xsl:template match="cac:Status//cbc:StatusReasonCode" priority="1000" mode="M8">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                       context="cac:Status//cbc:StatusReasonCode"/>

		    <!--ASSERT -->
      <xsl:choose>
         <xsl:when test="( ( not(contains(normalize-space(.),' ')) and contains( ' SV BV BW ',concat(' ',normalize-space(.),' ') ) ) )"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                                test="( ( not(contains(normalize-space(.),' ')) and contains( ' SV BV BW ',concat(' ',normalize-space(.),' ') ) ) )">
