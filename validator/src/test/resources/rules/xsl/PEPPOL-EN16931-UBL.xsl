...
<!--PATTERN -->
	...
	<!--RULE -->
<xsl:template match="ubl-creditnote:CreditNote | ubl-invoice:Invoice" priority="1014" mode="M12">
...
<xsl:apply-templates select="*" mode="M12"/>
	...
	<!--RULE -->
<xsl:template match="cbc:TaxCurrencyCode" priority="1013" mode="M12">
...
<xsl:apply-templates select="*" mode="M12"/>
	...
	<!--RULE -->
<xsl:template match="cac:AccountingCustomerParty/cac:Party" priority="1012" mode="M12">
...
<xsl:apply-templates select="*" mode="M12"/>
	...
	<!--RULE -->
<xsl:template match="cac:AccountingSupplierParty/cac:Party" priority="1011" mode="M12">
...
<xsl:apply-templates select="*" mode="M12"/>
	...
	<!--RULE -->
<xsl:template match="ubl-invoice:Invoice/cac:AllowanceCharge | ubl-invoice:Invoice/cac:InvoiceLine/cac:AllowanceCharge | ubl-creditnote:CreditNote/cac:AllowanceCharge | ubl-creditnote:CreditNote/cac:CreditNoteLine/cac:AllowanceCharge" priority="1008" mode="M12">
...
<xsl:apply-templates select="*" mode="M12"/>
	...
	<!--RULE -->
<xsl:template match="         cac:PaymentMeans[some $code in tokenize('49 59', '\s')           satisfies normalize-space(cbc:PaymentMeansCode) = $code]" priority="1007" mode="M12">
...
<xsl:apply-templates select="*" mode="M12"/>
	...
	<!--RULE -->
<xsl:template match="cac:TaxTotal[not(cac:TaxSubtotal)]/cbc:TaxAmount" priority="1005" mode="M12">
<svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="cac:TaxTotal[not(cac:TaxSubtotal)]/cbc:TaxAmount"/>

		<!--ASSERT -->
<xsl:choose>
<xsl:when test="/*/cbc:TaxCurrencyCode and @currencyID = /*/cbc:TaxCurrencyCode"/>
<xsl:otherwise>
<svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="/*/cbc:TaxCurrencyCode and @currencyID = /*/cbc:TaxCurrencyCode">
...
<xsl:apply-templates select="*" mode="M12"/>
	...
	<!--RULE -->
<xsl:template match="ubl-invoice:Invoice[cac:InvoicePeriod/cbc:StartDate]/cac:InvoiceLine/cac:InvoicePeriod/cbc:StartDate | ubl-creditnote:CreditNote[cac:InvoicePeriod/cbc:StartDate]/cac:CreditNoteLine/cac:InvoicePeriod/cbc:StartDate" priority="1004" mode="M12">
...
<xsl:apply-templates select="*" mode="M12"/>
	...
	<!--RULE -->
<xsl:template match="ubl-invoice:Invoice[cac:InvoicePeriod/cbc:EndDate]/cac:InvoiceLine/cac:InvoicePeriod/cbc:EndDate | ubl-creditnote:CreditNote[cac:InvoicePeriod/cbc:EndDate]/cac:CreditNoteLine/cac:InvoicePeriod/cbc:EndDate" priority="1003" mode="M12">
...
<xsl:apply-templates select="*" mode="M12"/>
	...
	<!--RULE -->
<xsl:template match="cac:InvoiceLine | cac:CreditNoteLine" priority="1002" mode="M12">
...
<xsl:apply-templates select="*" mode="M12"/>
	...
	<!--RULE -->
<xsl:template match="cac:Price/cbc:BaseQuantity[@unitCode]" priority="1000" mode="M12">
...
<!--PATTERN -->
	...
	<!--RULE -->
<xsl:template match="cac:AccountingSupplierParty/cac:Party[$supplierCountry = 'NO']" priority="1000" mode="M13">
...
<!--PATTERN -->
	...
	<!--RULE -->
<xsl:template match="ubl-creditnote:CreditNote | ubl-invoice:Invoice" priority="1003" mode="M14">
<svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="ubl-creditnote:CreditNote | ubl-invoice:Invoice"/>
...
<xsl:otherwise>
<svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="not(($supplierCountry = 'DK') and (normalize-space(cbc:AccountingCost/text()) = '') )">
...
<xsl:otherwise>
<svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="not(($supplierCountry = 'DK') and not(normalize-space(cac:AccountingSupplierParty/cac:Party/cac:PartyLegalEntity/cbc:CompanyID/text()) != '') )">
...
<xsl:otherwise>
<svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="not(($supplierCountry = 'DK') and (((boolean(cac:AccountingSupplierParty/cac:Party/cac:PartyIdentification/cbc:ID)) and (normalize-space(cac:AccountingSupplierParty/cac:Party/cac:PartyIdentification/cbc:ID/@schemeID) = '')) or ((boolean(cac:AccountingCustomerParty/cac:Party/cac:PartyIdentification/cbc:ID)) and (normalize-space(cac:AccountingCustomerParty/cac:Party/cac:PartyIdentification/cbc:ID/@schemeID) = '')) ) )">
...
<xsl:apply-templates select="*" mode="M14"/>
	...
	<!--RULE -->
<xsl:template match="ubl-creditnote:CreditNote/cac:CreditNoteLine | ubl-invoice:Invoice/cac:InvoiceLine" priority="1002" mode="M14">
<svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="ubl-creditnote:CreditNote/cac:CreditNoteLine | ubl-invoice:Invoice/cac:InvoiceLine"/>
...
<xsl:otherwise>
<svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="not(($supplierCountry = 'DK') and (cac:Item/cac:CommodityClassification/cbc:ItemClassificationCode/@listID = 'MP') and not((cac:Item/cac:CommodityClassification/cbc:ItemClassificationCode/@listVersionID = '19.05.01') or (cac:Item/cac:CommodityClassification/cbc:ItemClassificationCode/@listVersionID = '19.0501') ) )">
...
<xsl:apply-templates select="*" mode="M14"/>
	...
	<!--RULE -->
<xsl:template match="cac:AllowanceCharge" priority="1001" mode="M14">
...
<xsl:otherwise>
<svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="not(($supplierCountry = 'DK') and (cbc:AllowanceChargeReasonCode = 'ZZZ') and not((string-length(normalize-space(cbc:AllowanceChargeReason/text())) = 4) and (number(cbc:AllowanceChargeReason) &gt;= 0) and (number(cbc:AllowanceChargeReason) &lt;= 9999)) )">
...
<xsl:apply-templates select="*" mode="M14"/>
	...
	<!--RULE -->
<xsl:template match="ubl-invoice:Invoice/cac:PaymentMeans" priority="1000" mode="M14">
<svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="ubl-invoice:Invoice/cac:PaymentMeans"/>

		<!--ASSERT -->
<xsl:choose>
<xsl:when test="           not(($supplierCountry = 'DK')           and not(contains(' 1 10 31 42 48 49 50 58 59 93 97 ', concat(' ', cbc:PaymentMeansCode, ' ')))           )"/>
<xsl:otherwise>
<svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="not(($supplierCountry = 'DK') and not(contains(' 1 10 31 42 48 49 50 58 59 93 97 ', concat(' ', cbc:PaymentMeansCode, ' '))) )">
...
<xsl:otherwise>
<svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="not(($supplierCountry = 'DK') and ((cbc:PaymentMeansCode = '31') or (cbc:PaymentMeansCode = '42')) and not((normalize-space(cac:PayeeFinancialAccount/cbc:ID/text()) != '') and (normalize-space(cac:PayeeFinancialAccount/cac:FinancialInstitutionBranch/cbc:ID/text()) != '')) )">
...
<xsl:otherwise>
<svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="not(($supplierCountry = 'DK') and (cbc:PaymentMeansCode = '49') and not((normalize-space(cac:PaymentMandate/cbc:ID/text()) != '') and (normalize-space(cac:PaymentMandate/cac:PayerFinancialAccount/cbc:ID/text()) != '')) )">
...
<xsl:otherwise>
<svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="not(($supplierCountry = 'DK') and (cbc:PaymentMeansCode = '50') and not(((substring(cbc:PaymentID, 0, 4) = '01#') or (substring(cbc:PaymentID, 0, 4) = '04#') or (substring(cbc:PaymentID, 0, 4) = '15#')) and (string-length(cac:PayeeFinancialAccount/cbc:ID/text()) = 7) ) )">
...
<xsl:otherwise>
<svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="not(($supplierCountry = 'DK') and (cbc:PaymentMeansCode = '50') and ((substring(cbc:PaymentID, 0, 4) = '04#') or (substring(cbc:PaymentID, 0, 4) = '15#')) and not(string-length(cbc:PaymentID) = 19) )">
...
<xsl:otherwise>
<svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="not(($supplierCountry = 'DK') and (cbc:PaymentMeansCode = '93') and not(((substring(cbc:PaymentID, 0, 4) = '71#') or (substring(cbc:PaymentID, 0, 4) = '73#') or (substring(cbc:PaymentID, 0, 4) = '75#')) and (string-length(cac:PayeeFinancialAccount/cbc:ID/text()) = 8) ) )">
...
<xsl:otherwise>
<svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="not(($supplierCountry = 'DK') and (cbc:PaymentMeansCode = '93') and ((substring(cbc:PaymentID, 0, 4) = '71#') or (substring(cbc:PaymentID, 0, 4) = '75#')) and not((string-length(cbc:PaymentID) = 18) or (string-length(cbc:PaymentID) = 19)) )">
...
<xsl:otherwise>
<svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="not(($supplierCountry = 'DK') and (cbc:PaymentMeansCode = '97') )">
...
<!--PATTERN -->
	...
	<!--RULE -->
<xsl:template match="cac:AccountingSupplierParty/cac:Party[$supplierCountry = 'IT']" priority="1000" mode="M15">
...
<xsl:otherwise>
<svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="(exists(cac:PartyTaxScheme/cbc:CompanyID) and cac:PartyTaxScheme/cac:TaxScheme/cbc:ID = 'IT:TR')">
...
<xsl:otherwise>
<svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="exists(cac:PostalAddress/cbc:StreetName)">
...
<xsl:otherwise>
<svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="exists(cac:PostalAddress/cbc:CityName)">
...
<xsl:otherwise>
<svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="exists(cac:PostalAddress/cbc:PostalZone)">
...
<!--PATTERN -->
	...
	<!--RULE -->
<xsl:template match="//cac:AccountingSupplierParty/cac:Party[cac:PostalAddress/cac:Country/cbc:IdentificationCode = 'SE' and cac:PartyTaxScheme[cac:TaxScheme/cbc:ID = 'VAT']/substring(cbc:CompanyID, 1, 2) = 'SE']" priority="1006" mode="M16">
...
<xsl:apply-templates select="*" mode="M16"/>
	...
	<!--RULE -->
<xsl:template match="//cac:AccountingSupplierParty/cac:Party/cac:PartyLegalEntity[../cac:PostalAddress/cac:Country/cbc:IdentificationCode = 'SE' and cbc:CompanyID]" priority="1005" mode="M16">
...
<xsl:apply-templates select="*" mode="M16"/>
	...
	<!--RULE -->
<xsl:template match="//cac:AccountingSupplierParty/cac:Party[cac:PostalAddress/cac:Country/cbc:IdentificationCode = 'SE' and exists(cac:PartyLegalEntity/cbc:CompanyID)]/cac:PartyTaxScheme[normalize-space(upper-case(cac:TaxScheme/cbc:ID)) != 'VAT']/cbc:CompanyID" priority="1004" mode="M16">
...
<xsl:apply-templates select="*" mode="M16"/>
	...
	<!--RULE -->
<xsl:template match="//cac:PaymentMeans[//cac:AccountingSupplierParty/cac:Party[cac:PostalAddress/cac:Country/cbc:IdentificationCode = 'SE'] and normalize-space(cbc:PaymentMeansCode) = '30' and normalize-space(cac:PayeeFinancialAccount/cac:FinancialInstitutionBranch/cbc:ID) = 'SE:PLUSGIRO']/cac:PayeeFinancialAccount/cbc:ID" priority="1002" mode="M16">
...
<xsl:apply-templates select="*" mode="M16"/>
	...
	<!--RULE -->
<xsl:template match="//cac:PaymentMeans[//cac:AccountingSupplierParty/cac:Party[cac:PostalAddress/cac:Country/cbc:IdentificationCode = 'SE'] and normalize-space(cbc:PaymentMeansCode) = '30' and normalize-space(cac:PayeeFinancialAccount/cac:FinancialInstitutionBranch/cbc:ID) = 'SE:BANKGIRO']/cac:PayeeFinancialAccount/cbc:ID" priority="1001" mode="M16">
...
<xsl:apply-templates select="*" mode="M16"/>
	...
	<!--RULE -->
<xsl:template match="//cac:PaymentMeans[//cac:AccountingSupplierParty/cac:Party[cac:PostalAddress/cac:Country/cbc:IdentificationCode = 'SE'] and (cbc:PaymentMeansCode = normalize-space('50') or cbc:PaymentMeansCode = normalize-space('56'))]" priority="1000" mode="M16">
...
<xsl:variable name="UNCL5305" select="tokenize('AE E S Z G O K L M', '\s')"/>
	...
	<!--RULE -->
<xsl:template match="cbc:EmbeddedDocumentBinaryObject[@mimeCode]" priority="1009" mode="M17">
...
<xsl:apply-templates select="*" mode="M17"/>
	...
	<!--RULE -->
<xsl:template match="cac:AllowanceCharge[cbc:ChargeIndicator = 'false']/cbc:AllowanceChargeReasonCode" priority="1008" mode="M17">
...
<xsl:apply-templates select="*" mode="M17"/>
	...
	<!--RULE -->
<xsl:template match="cac:AllowanceCharge[cbc:ChargeIndicator = 'true']/cbc:AllowanceChargeReasonCode" priority="1007" mode="M17">
...
<xsl:apply-templates select="*" mode="M17"/>
	...
	<!--RULE -->
<xsl:template match="cac:ClassifiedTaxCategory/cbc:ID | cac:TaxCategory/cbc:ID" priority="1006" mode="M17">
<svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="cac:ClassifiedTaxCategory/cbc:ID | cac:TaxCategory/cbc:ID"/>
...
<xsl:apply-templates select="*" mode="M17"/>
	...
	<!--RULE -->
<xsl:template match="cac:Country/cbc:IdentificationCode | cac:OriginCountry/cbc:IdentificationCode" priority="1005" mode="M17">
<svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="cac:Country/cbc:IdentificationCode | cac:OriginCountry/cbc:IdentificationCode"/>

		<!--ASSERT -->
<xsl:choose>
<xsl:when test="           some $code in $ISO3166             satisfies text() = $code"/>
<xsl:otherwise>
<svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="some $code in $ISO3166 satisfies text() = $code">
...
<xsl:apply-templates select="*" mode="M17"/>
	...
	<!--RULE -->
<xsl:template match="cac:InvoicePeriod/cbc:DescriptionCode" priority="1004" mode="M17">
...
<xsl:apply-templates select="*" mode="M17"/>
	...
	<!--RULE -->
<xsl:template match="cbc:Amount | cbc:BaseAmount | cbc:PriceAmount | cbc:TaxAmount | cbc:TaxableAmount | cbc:LineExtensionAmount | cbc:TaxExclusiveAmount | cbc:TaxInclusiveAmount | cbc:AllowanceTotalAmount | cbc:ChargeTotalAmount | cbc:PrepaidAmount | cbc:PayableRoundingAmount | cbc:PayableAmount" priority="1003" mode="M17">
...
<xsl:apply-templates select="*" mode="M17"/>
	...
	<!--RULE -->
<xsl:template match="cbc:InvoiceTypeCode" priority="1002" mode="M17">
...
<xsl:apply-templates select="*" mode="M17"/>
	...
	<!--RULE -->
<xsl:template match="cbc:CreditNoteTypeCode" priority="1001" mode="M17">
...
<xsl:apply-templates select="*" mode="M17"/>
	...
	<!--RULE -->
<xsl:template match="cbc:IssueDate | cbc:DueDate | cbc:TaxPointDate | cbc:StartDate | cbc:EndDate | cbc:ActualDeliveryDate" priority="1000" mode="M17">
