<xsl:stylesheet xmlns:xs="http://www.w3.org/2001/XMLSchema"
   ...
   <xsl:template match="/">
      <svrl:schematron-output xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                              title="Norwegian rules for EHF Despatch Advice"
                              schemaVersion="iso">
         <xsl:comment>
   ...
   <!--PATTERN -->
	  ...
	  <!--RULE -->
   <xsl:template match="cac:Country" priority="1006" mode="M4">
	  ...
	  <!--RULE -->
   <xsl:template match="cac:DespatchSupplierParty" priority="1005" mode="M4">
	  ...
	  <!--RULE -->
   <xsl:template match="cac:DeliverCustomerParty" priority="1004" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                       context="cac:DeliverCustomerParty"/>
	  ...
	  <!--RULE -->
   <xsl:template match="cac:BuyerCustomerParty" priority="1003" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
	  ...
	  <!--RULE -->
   <xsl:template match="cac:OriginatorCustomerParty" priority="1002" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
	  ...
	  <!--RULE -->
   <xsl:template match="cac:CarrierParty/cac:Person" priority="1001" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                       context="cac:CarrierParty/cac:Person"/>
