<xsl:stylesheet xmlns:xs="http://www.w3.org/2001/XMLSchema"
   ...
   <xsl:template match="/">
      <svrl:schematron-output xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                              title="Norwegian rules for EHF Punch Out"
                              schemaVersion="iso">
         <xsl:comment>
   ...
   <!--SCHEMATRON PATTERNS-->
   <svrl:text xmlns:svrl="http://purl.oclc.org/dsdl/svrl">Norwegian rules for EHF Punch Out</svrl:text>

   <!--PATTERN -->


	  <!--RULE -->
   <xsl:template match="ubl:Catalogue" priority="1002" mode="M4">
	  ...
	  <!--RULE -->
   <xsl:template match="cac:Item" priority="1001" mode="M4">
