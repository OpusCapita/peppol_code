<xsl:stylesheet xmlns:xs="http://www.w3.org/2001/XMLSchema"
   ...
   <xsl:template match="/">
      <svrl:schematron-output xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                              title="Norwegian rules for EHF Order Agreement"
                              schemaVersion="iso">
         <xsl:comment>
   ...
   <!--SCHEMATRON PATTERNS-->
   <svrl:text xmlns:svrl="http://purl.oclc.org/dsdl/svrl">Norwegian rules for EHF Order Agreement</svrl:text>

   <!--PATTERN -->


	  <!--RULE -->
   <xsl:template match="ubl:OrderResponse" priority="1004" mode="M4">
	  ...
	  <!--RULE -->
   <xsl:template match="cac:PromisedDeliveryPeriod" priority="1003" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                       context="cac:PromisedDeliveryPeriod"/>
	  ...
	  <!--RULE -->
   <xsl:template match="cac:LegalMonetaryTotal" priority="1002" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
	  ...
	  <!--RULE -->
   <xsl:template match="cac:LineItem" priority="1001" mode="M4">
	  ...
	  <!--RULE -->
   <xsl:template match="cac:AdditionalItemProperty" priority="1000" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
