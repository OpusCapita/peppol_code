...
<xsl:stylesheet xmlns:xs="http://www.w3.org/2001/XMLSchema"
   ...
   <xsl:variable name="taxCategories"
	  ...
	  <!--RULE -->
   <xsl:template match="ubl:CreditNote" priority="1014" mode="M8">
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
               ...
               <xsl:attribute name="id">NONAT-T14-R023</xsl:attribute>
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="cbc:UBLVersionID">
               <xsl:attribute name="id">NONAT-T14-R015</xsl:attribute>
               <xsl:attribute name="flag">fatal</xsl:attribute>
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
               </xsl:attribute>
	  ...
	  <!--RULE -->
   <xsl:template match="cbc:UBLVersionID" priority="1013" mode="M8">
   ...
   <xsl:template match="cac:PayeeFinancialAccount/cbc:ID[@schemeID]"
	  ...
	  <!--RULE -->
   <xsl:template match="cac:LegalMonetaryTotal" priority="1007" mode="M8">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
	  ...
	  <!--RULE -->
   <xsl:template match="cac:AllowanceCharge" priority="1006" mode="M8">
	  ...
	  <!--RULE -->
   <xsl:template match="cac:TaxCategory/cbc:ID" priority="1005" mode="M8">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                       context="cac:TaxCategory/cbc:ID"/>

		    <!--ASSERT -->
      <xsl:choose>
         <xsl:when test="some $cat in tokenize('AA E H K R S Z', '\s') satisfies $cat = normalize-space(.)"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                                test="some $cat in tokenize('AA E H K R S Z', '\s') satisfies $cat = normalize-space(.)">
               <xsl:attribute name="id">NONAT-T14-R017</xsl:attribute>
               <xsl:attribute name="flag">fatal</xsl:attribute>
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
               </xsl:attribute>
   ...
   <xsl:template match="cac:ClassifiedTaxCategory/cbc:ID" priority="1004" mode="M8">
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                                test="some $cat in tokenize('AA E H K R S Z', '\s') satisfies $cat = normalize-space(.)">
               <xsl:attribute name="id">NONAT-T14-R028</xsl:attribute>
               <xsl:attribute name="flag">fatal</xsl:attribute>
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
               </xsl:attribute>
               <svrl:text>[NONAT-T14-R028]-Credit Note tax categories MUST be one of the follwoing codes:  AA E H K R S Z</svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
      <xsl:apply-templates select="@*|*|comment()|processing-instruction()" mode="M8"/>
	  ...
	  <!--RULE -->
   <xsl:template match="cac:CreditNoteLine" priority="1003" mode="M8">
