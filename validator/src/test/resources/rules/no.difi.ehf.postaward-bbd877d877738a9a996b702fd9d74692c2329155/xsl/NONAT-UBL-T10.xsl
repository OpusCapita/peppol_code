...
<xsl:stylesheet xmlns:xs="http://www.w3.org/2001/XMLSchema"
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
               ...
               <xsl:attribute name="id">NONAT-T10-R025</xsl:attribute>
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="cbc:UBLVersionID">
               <xsl:attribute name="id">NONAT-T10-R019</xsl:attribute>
               <xsl:attribute name="flag">fatal</xsl:attribute>
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
               </xsl:attribute>
   ...
   <xsl:template match="cac:InvoiceLine" priority="1006" mode="M8">
	  ...
	  <!--RULE -->
   <xsl:template match="cac:TaxSubtotal" priority="1005" mode="M8">
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
               ...
               <xsl:attribute name="id">NONAT-T10-R030</xsl:attribute>
               <xsl:attribute name="flag">fatal</xsl:attribute>
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
               </xsl:attribute>
