...
<xsl:stylesheet
    ...
    <!--RULE -->
    <xsl:template
            match="//*[@amountCurrencyID][not(self::cac:TaxCurrencyTaxAmount)][/sfti:Invoice/sfti:InvoiceCurrencyCode]"
            priority="1000"
            mode="M20">
    ...
    <!--RULE -->
    <xsl:template
            match="/sfti:Invoice/cac:InvoiceLine[cac:Item/cac:BasePrice][cac:AllowanceCharge/cbc:ChargeIndicator='false' or cac:AllowanceCharge/cbc:ChargeIndicator='0'][cac:AllowanceCharge/cbc:Amount][cac:Item/cac:BasePrice/cbc:BaseQuantity]"
            priority="1000"
            mode="M43">
        <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
    ...
    <!--RULE -->
    <xsl:template
            match="/sfti:Invoice/cac:InvoiceLine[cac:Item/cac:BasePrice][cac:AllowanceCharge/cbc:ChargeIndicator='false' or cac:AllowanceCharge/cbc:ChargeIndicator='0'][cac:AllowanceCharge/cbc:Amount][not(cac:Item/cac:BasePrice/cbc:BaseQuantity)]"
            priority="1000"
            mode="M44">
        <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
    ...
    <!--RULE -->
    <xsl:template
            match="/sfti:Invoice/cac:InvoiceLine[cac:Item/cac:BasePrice][cac:AllowanceCharge/cbc:ChargeIndicator='true' or cac:AllowanceCharge/cbc:ChargeIndicator='1'][cac:AllowanceCharge/cbc:Amount][cac:Item/cac:BasePrice/cbc:BaseQuantity]"
            priority="1000"
            mode="M45">
        <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
    ...
    <!--RULE -->
    <xsl:template
            match="/sfti:Invoice/cac:InvoiceLine[cac:Item/cac:BasePrice][cac:AllowanceCharge/cbc:ChargeIndicator='true' or cac:AllowanceCharge/cbc:ChargeIndicator='1'][cac:AllowanceCharge/cbc:Amount][not(cac:Item/cac:BasePrice/cbc:BaseQuantity)]"
            priority="1000"
            mode="M46">
        <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
    ...
    <!--RULE -->
    <xsl:template
            match="/sfti:Invoice/cac:InvoiceLine[cbc:InvoicedQuantity][cac:Item/cac:BasePrice][cac:Item/cac:BasePrice/cbc:BaseQuantity][cac:AllowanceCharge/cac:AllowanceChargeBaseAmount]"
            priority="1000"
            mode="M49">
        <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
    ...
    <!--RULE -->
    <xsl:template
            match="/sfti:Invoice/cac:InvoiceLine[cbc:InvoicedQuantity][cac:Item/cac:BasePrice][not(cac:Item/cac:BasePrice/cbc:BaseQuantity)][cac:AllowanceCharge/cac:AllowanceChargeBaseAmount]"
            priority="1000"
            mode="M50">
        <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
            ...
            <xsl:otherwise>
                <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                    ...
                    <svrl:text>
                        ...
                        /sfti:Invoice/sfti:InvoiceCurrencyCode [R-5]
                    </svrl:text>
                </svrl:failed-assert>
            </xsl:otherwise>
        </xsl:choose>
    ...
    <!--RULE -->
    <xsl:template
            match="/sfti:Invoice[sfti:TaxCurrencyCode][sfti:TaxCurrencyCode != sfti:InvoiceCurrencyCode][cac:ExchangeRate/cbc:CalculationRate]/cac:TaxTotal"
            priority="1000"
            mode="M85">
        <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
    ...
    <!--RULE -->
    <xsl:template
            match="sfti:Invoice/sfti:AdditionalDocumentReference/cac:ID[@identificationSchemeAgencyName and @identificationSchemeID]"
            priority="1000"
            mode="M91">
        <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
    ...
    <!--RULE -->
    <xsl:template
            match="sfti:Invoice/sfti:AdditionalDocumentReference/cac:ID[@identificationSchemeAgencyName and contains('[CT][ACD][DQ][ATS]',concat('[',@identificationSchemeID,']'))]"
            priority="1000"
            mode="M92">
        <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
    ...
    <!--RULE -->
    <xsl:template
            match="sfti:Invoice/sfti:AdditionalDocumentReference/cac:ID[@identificationSchemeAgencyName and not(@identificationSchemeID)]"
            priority="1000"
            mode="M93">
        <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
    ...
    <!--RULE -->
    <xsl:template
            match="sfti:Invoice/sfti:AdditionalDocumentReference/cac:ID[@identificationSchemeAgencyName='SFTI' and @identificationSchemeID]"
            priority="1000"
            mode="M94">
        <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
    ...
    <!--RULE -->
    <xsl:template
            match="sfti:Invoice/sfti:AdditionalDocumentReference/cac:ID[@identificationSchemeAgencyName='SFTI' and not(@identificationSchemeID)]"
            priority="1000"
            mode="M95">
        <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
    ...
    <!--RULE -->
    <xsl:template
            match="sfti:Invoice/sfti:AdditionalDocumentReference/cac:ID[not(@identificationSchemeAgencyName) and @identificationSchemeID]"
            priority="1000"
            mode="M96">
        <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
